...
const clients = [
  { id: 1, name: "Budmax Sp. z o.o.", person: "Marek Kowalski", status: "Aktywny", potential: "VIP", revenue: "138 400 zł", margin: "22%", city: "Warszawa", lastContact: "2 dni temu", phone: "+48 601 234 567" },
  { id: 2, name: "Hydrotech Polska", person: "Anna Wiśniewska", status: "Aktywny", potential: "Wysoki", revenue: "94 200 zł", margin: "18%", city: "Kraków", lastContact: "5 dni temu", phone: "+48 602 345 678" },
  { id: 3, name: "Invest-Bud Kraków", person: "Piotr Nowak", status: "Prospekt", potential: "Wysoki", revenue: "67 800 zł", margin: "15%", city: "Wrocław", lastContact: "1 tydzień temu", phone: "+48 603 456 789" },
  { id: 4, name: "Stal-Beton Łódź", person: "Katarzyna Maj", status: "Aktywny", potential: "Średni", revenue: "45 100 zł", margin: "12%", city: "Łódź", lastContact: "3 dni temu", phone: "+48 604 567 890" },
  { id: 5, name: "Prefabet Wrocław", person: "Tomasz Zając", status: "Nieaktywny", potential: "Niski", revenue: "18 300 zł", margin: "8%", city: "Gdańsk", lastContact: "3 tygodnie temu", phone: "+48 605 678 901" },
  { id: 6, name: "DachPol SA", person: "Ewa Kowalczyk", status: "Aktywny", potential: "Wysoki", revenue: "82 600 zł", margin: "19%", city: "Poznań", lastContact: "1 dzień temu", phone: "+48 606 789 012" },
];
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <div className="text-white text-2xl font-bold">Dzień dobry, Piotr 👋</div>
      </div>
      <div className="flex gap-4 flex-wrap">
        {[
          { icon: "👥", label: "Klienci", value: "47", sub: "5 nowych w tym miesiącu", color: "bg-blue-500" },
          { icon: "💰", label: "Obrót YTD", value: "836 400 zł", sub: "Cel: 1 200 000 zł", color: "bg-emerald-500" },
          { icon: "📊", label: "Śr. marża", value: "16,4%", sub: "Cel: 18%", color: "bg-purple-500" },
    ...
    <div className="flex gap-4 h-full">
      <div className="flex flex-col gap-3 flex-1">
        <div className="flex gap-3">
          ...
          <button className="bg-blue-600 hover:bg-blue-500 text-white font-bold text-xl w-12 rounded-xl">+</button>
        </div>
        ...
        <div className="flex flex-col gap-2 overflow-y-auto">
          {filtered.map(c => (
            <div key={c.id} onClick={() => setSelected(c)}
              className={`bg-[#141929] border rounded-xl p-4 cursor-pointer flex items-center gap-4 ${selected?.id===c.id ? "border-blue-500/60 bg-blue-500/10" : "border-[#1E2D45]"}`}>
        ...
        <div className="w-80 bg-[#141929] border border-[#1E2D45] rounded-2xl flex flex-col overflow-hidden flex-shrink-0">
          ...
          <div className="p-4 flex flex-col gap-3 flex-1">
            ...
            <div className="bg-[#0B0F1A] rounded-xl p-3">
              ...
              <div className="text-slate-300 text-xs leading-relaxed">Stały klient od 3 lat. Preferuje kontakt telefoniczny w godzinach 9–12.</div>
            </div>
